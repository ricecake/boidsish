...
namespace Boidsish {
    ...
    public:
        TypedBuffer(GLenum target, GLenum usage = GL_STATIC_DRAW)
            : Buffer(target), usage_(usage) {}
    ...
    public:
        explicit VertexBuffer(GLenum usage = GL_STATIC_DRAW)
            : TypedBuffer<T>(GL_ARRAY_BUFFER, usage) {}
    };
    ...
    public:
        explicit IndexBuffer(GLenum usage = GL_STATIC_DRAW)
            : TypedBuffer<T>(GL_ELEMENT_ARRAY_BUFFER, usage) {}
    };
    ...
    public:
        explicit UniformBuffer(GLenum usage = GL_DYNAMIC_DRAW)
            : TypedBuffer<T>(GL_UNIFORM_BUFFER, usage) {}
    ...
    public:
        explicit ShaderStorageBuffer(GLenum usage = GL_DYNAMIC_DRAW)
            : TypedBuffer<T>(GL_SHADER_STORAGE_BUFFER, usage) {}
    ...
    public:
        explicit IndirectBuffer(GLenum usage = GL_DYNAMIC_DRAW)
            : TypedBuffer<T>(GL_DRAW_INDIRECT_BUFFER, usage) {}
    };
