...
namespace Boidsish {
	...
	namespace WeatherConstants {
		// Paces and Ranges
		constexpr WeatherAttributeInfo SunIntensity = {0.1f, 1.0f, 1.2f, 10.0f};
		constexpr WeatherAttributeInfo WindStrength = {0.01f, 0.05f, 0.5f, 10.0f};
		constexpr WeatherAttributeInfo WindSpeed = {0.01f, 0.075f, 0.8f, 10.0f};
		constexpr WeatherAttributeInfo WindFrequency = {0.005f, 0.01f, 0.08f, 10.0f};
		constexpr WeatherAttributeInfo CloudDensity = {0.1f, 0.20f, 1.0f, 10.0f};
		constexpr WeatherAttributeInfo CloudAltitude = {100.0f, 400.0f, 800.0f, 10.0f};
		constexpr WeatherAttributeInfo CloudThickness = {50.0f, 200.0f, 800.0f, 10.0f};
		...
		constexpr WeatherAttributeInfo MieScale = {0.05f, 0.35f, 4.0f, 10.0f};
		constexpr WeatherAttributeInfo AtmosphereHeight = {30.0f, 120.0f, 150.0f, 10.0f};
		constexpr WeatherAttributeInfo RayleighScaleHeight = {4.0f, 8.0f, 10.0f, 10.0f};
		constexpr WeatherAttributeInfo MieScaleHeight = {1.0f, 1.2f, 10.0f, 10.0f};
		constexpr WeatherAttributeInfo CloudCoverage = {0.0f, 0.85f, 1.0f, 10.0f};
		constexpr WeatherAttributeInfo Precipitation = {0.0f, 0.0f, 1.0f, 10.0f};
		constexpr WeatherAttributeInfo Temperature = {263.15f, 288.15f, 313.15f, 10.0f}; // -10C to 40C
