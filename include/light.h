...
namespace Boidsish {
	...
	struct alignas(16) LightingUbo {
		...
		float cloudPowderMultiplier;             // offset 764, 4 bytes
		float cloudPowderLocalScale;             // offset 768, 4 bytes
		float cloudShadowOpticalDepthMultiplier; // offset 772, 4 bytes
		float cloudShadowStepMultiplier;         // offset 776, 4 bytes
		float cloudSunLightScale;                // offset 780, 4 bytes
		float cloudMoonLightScale;               // offset 784, 4 bytes
		float cloudBeerPowderMix;                // offset 788, 4 bytes
		float cloudFlowSpeed;                    // offset 792, 4 bytes
		float cloudFlowDirection;                // offset 796, 4 bytes
		float cloudFlowHeightScale;              // offset 800, 4 bytes
		float cloudCurlStrength;                 // offset 804, 4 bytes
		float cloudCurlFrequency;                // offset 808, 4 bytes
		float sunAureoleStrength;                // offset 812, 4 bytes
		float cirrusOpacity;                     // offset 816, 4 bytes
		float _pad_clouds3;                      // offset 820, 4 bytes
		float _pad_cloud_shadow_mat[10];         // offset 824, 40 bytes
