...
public:
    ...
    size_t AddEffect(const glm::vec3& position, const glm::vec3& direction, size_t particle_count = 1024);
    void UpdateEffectPosition(size_t id, const glm::vec3& position);
    void UpdateEffectDirection(size_t id, const glm::vec3& direction);
