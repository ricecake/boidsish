...
namespace Boidsish {
	...
	void RegisterAllShaderConstants() {
		...
		T::RegisterConstant("CLOUD_2D_PROPS_BINDING", Constants::TextureUnit::Cloud2DProps());
		T::RegisterConstant("CLOUD_3D_FRONT_BINDING", Constants::TextureUnit::Cloud3DFront());
	}
