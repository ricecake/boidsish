...
namespace Boidsish {
	...
	private:
		...
		void
		RegisterKey(const std::string& section, const std::string& key, ConfigValue::Type type, float default_value);
		void
		RegisterKey(const std::string& section, const std::string& key, ConfigValue::Type type, bool default_value);
