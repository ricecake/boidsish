...
namespace Boidsish {
	...
	struct FrameConfigCache {
		...
		float weight_leaf = 1.0f;
		float weight_petal = 1.0f;
		float weight_bubble = 1.0f;
		float weight_snow = 1.0f;
		float weight_firefly = 1.0f;
		float weight_bird = 1.0f;
	...
	public:
		...
		void
		SetFireEffectSourceModel(const std::shared_ptr<FireEffect>& effect, const std::shared_ptr<Model>& model) const;
