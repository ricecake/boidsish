...
namespace Boidsish {
	namespace Constants {
		...
		namespace SsboBinding {
			...
			consteval int TreeInstances() {
				return std::to_underlying(Constants::Bindings::Ssbo::TreeInstances);
			}

			consteval int TreeIndirect() {
				return std::to_underlying(Constants::Bindings::Ssbo::TreeIndirect);
			}
