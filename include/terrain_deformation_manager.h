...
public:
	 ...
	 */
	DeformationQueryResult QueryDeformations(
	 ...
	 */
	std::vector<std::shared_ptr<TerrainDeformation>> FindDeformationsInRadius(
	 ...
	 * @return Vector of deformation pointers
	 */
	std::vector<std::shared_ptr<TerrainDeformation>> FindDeformationsInAABB(
