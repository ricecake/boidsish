...
public:
    ...
    void UpdateEntity(const EntityHandler& handler, float time, float delta_time) override {
        ...
        // Vector3 spiral_motion = circular_motion + com_vec + (rightHandedNess? 1 : -1) *circular_motion.Cross(com_vec); // AWESOME
        // Vector3 spiral_motion = com_vec + ((rightHandedNess? 1 : -1) * circular_motion.Cross(com_vec)); // AWESOME -- maybe not as much?
        // Vector3 spiral_motion = circular_motion + 2*com_vec + (rightHandedNess? 1 : -1) *circular_motion.Cross(com_vec); // AWESOME
        // Vector3 spiral_motion = circular_motion + circ + (rightHandedNess? 1 : -1) *circular_motion.Cross(com_vec); // AWESOME
