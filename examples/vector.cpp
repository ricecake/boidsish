...
void FruitEntity::UpdateEntity(const EntityHandler& handler, float, float delta_time, const Visualizer* vis) {
	phase_ += delta_time;
...
void VectorDemoEntity::UpdateEntity(const EntityHandler& handler, float time, float delta_time, const Visualizer* vis) {
...
void FlockingEntity::UpdateEntity(const EntityHandler& handler, float time, float delta_time, const Visualizer* vis) {
	(void)time;
