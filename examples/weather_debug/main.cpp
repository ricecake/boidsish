...
int main() {
    try {
        ...
        auto tempHud = visualizer.AddHudMessage("Temperature: --", HudAlignment::TOP_LEFT, {10, 10}, 0.5f);
        auto humHud = visualizer.AddHudMessage("Humidity: --", HudAlignment::TOP_LEFT, {10, 40}, 0.5f);
        auto windHud = visualizer.AddHudMessage("Wind: --", HudAlignment::TOP_LEFT, {10, 70}, 0.5f);
        auto aerosolHud = visualizer.AddHudMessage("Aerosol: --", HudAlignment::TOP_LEFT, {10, 100}, 0.5f);
        auto cloudHud = visualizer.AddHudMessage("Clouds: --", HudAlignment::TOP_LEFT, {10, 130}, 0.5f);
        auto timeHud = visualizer.AddHudMessage("Time: --", HudAlignment::TOP_LEFT, {10, 160}, 0.5f);
