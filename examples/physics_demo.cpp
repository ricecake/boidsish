...
public:
    PhysicsDemoEntity(int id, const std::string& modelPath)
        : Boidsish::Entity<Boidsish::Model>(id) {
...
int main(int argc, char** argv) {
    ...
    physicsEntities.push_back(std::make_shared<Boidsish::PhysicsEntity<PhysicsDemoEntity>>(cubeEntity, physicsHandler, 1.0f));
