...
namespace Boidsish {
	...
	void WeatherManager::InitializePresets() {
		...
		sunny.name = "Sunny";
		sunny.weight = 10.0f;
		sunny.settings.sun_intensity = {9.0f, 11.0f};
		...
		cloudy.name = "Cloudy";
		cloudy.weight = 6.0f;
		cloudy.settings.sun_intensity = {5.0f, 8.0f};
		...
		overcast.settings.sun_intensity = {2.0f, 5.0f};
		...
		foggy.name = "Foggy";
		foggy.weight = 2.0f;
		foggy.settings.sun_intensity = {1.0f, 3.0f};
