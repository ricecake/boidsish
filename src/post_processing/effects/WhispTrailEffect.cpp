...
namespace Boidsish {
	namespace PostProcessing {
		...
		void WhispTrailEffect::Apply(GLuint sourceTexture, GLuint depthTexture, GLuint velocityTexture, GLuint normalTexture, GLuint albedoTexture, const glm::mat4& viewMatrix, const glm::mat4& projectionMatrix, const glm::vec3& cameraPos) {
			// Save original state
			GLint previous_fbo;
