...
namespace Boidsish {
	namespace PostProcessing {
		...
		void AtmosphereEffect::Apply(GLuint sourceTexture, GLuint depthTexture, GLuint velocityTexture, GLuint normalTexture, GLuint albedoTexture, const glm::mat4& viewMatrix, const glm::mat4& projectionMatrix, const glm::vec3& cameraPos) {
			...
			composite_shader_->trySetInt("normalTexture", 3);
			...
			composite_shader_->trySetInt("u_cloudShadowMap", Constants::TextureUnit::AtmosphereCloudShadow());
			composite_shader_->trySetInt("shadowMaps", Constants::TextureUnit::ShadowMaps());
