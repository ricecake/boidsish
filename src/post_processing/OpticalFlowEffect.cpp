...
namespace Boidsish {
    namespace PostProcessing {
        ...
        void OpticalFlowEffect::Initialize(int width, int height) {
            _shader = std::make_unique<Shader>("shaders/post_processing/optical_flow.vert", "shaders/post_processing/optical_flow.frag");
            _passthroughShader = std::make_unique<Shader>("shaders/post_processing/optical_flow.vert", "shaders/post_processing/passthrough.frag");
            Resize(width, height);
        }
