...
namespace Boidsish {
	...
	Mesh Model::processMesh(aiMesh* mesh, const aiScene* scene) {
		...
		// 1. diffuse maps
		std::vector<Boidsish::Texture> diffuseMaps = loadMaterialTextures(material, aiTextureType_DIFFUSE, "texture_diffuse");
		...
		// 3. normal maps
		std::vector<Boidsish::Texture> normalMaps = loadMaterialTextures(material, aiTextureType_HEIGHT, "texture_normal");
		textures.insert(textures.end(), normalMaps.begin(), normalMaps.end());
		// 4. height maps
		std::vector<Boidsish::Texture> heightMaps = loadMaterialTextures(material, aiTextureType_AMBIENT, "texture_height");
	...
	std::vector<Boidsish::Texture> Model::loadMaterialTextures(aiMaterial* mat, aiTextureType type, std::string typeName) {
		std::vector<Boidsish::Texture> textures;
