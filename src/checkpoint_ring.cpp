...
namespace Boidsish {
    ...
    void CheckpointRingShape::render() const {
        if (!checkpoint_shader_ || quad_vao_ == 0) return;
    ...
    void CheckpointRingShape::render(Shader& shader, const glm::mat4& model_matrix) const {
        ...
        glm::vec3 color(1.0f);
        switch (style_) {
            case CheckpointStyle::GOLD: color = Constants::Class::Checkpoint::Colors::Gold(); break;
            case CheckpointStyle::SILVER: color = Constants::Class::Checkpoint::Colors::Silver(); break;
            case CheckpointStyle::BLACK: color = Constants::Class::Checkpoint::Colors::Black(); break;
            case CheckpointStyle::BLUE: color = Constants::Class::Checkpoint::Colors::Blue(); break;
            case CheckpointStyle::NEON_GREEN: color = Constants::Class::Checkpoint::Colors::NeonGreen(); break;
            default: color = glm::vec3(GetR(), GetG(), GetB()); break;
        }
