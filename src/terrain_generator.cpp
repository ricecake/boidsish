...
namespace Boidsish {
	...
	auto TerrainGenerator::fbm(float x, float z, TerrainParameters params) const {
		glm::vec3 total;
	...
	bool TerrainGenerator::Raycast(const glm::vec3& origin, const glm::vec3& dir, float max_dist, float& out_dist) const
	{
