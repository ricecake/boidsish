...
namespace Boidsish {
    ...
    FloorManager::FloorManager(int width, int height) : width_(width), height_(height) {
        plane_shader_ = std::make_unique<Shader>("shaders/plane.vert", "shaders/plane.frag");
        blur_shader_ = std::make_unique<Shader>("shaders/blur.vert", "shaders/blur.frag");
    ...
    void FloorManager::SetupPlaneMesh() {
        float quad_vertices[] = {
    ...
    void FloorManager::SetupFBOs(int width, int height) {
    ...
    void FloorManager::Render(const glm::mat4& view, const glm::mat4& projection, const glm::mat4& reflection_vp) {
        ...
        plane_shader_->setMat4("reflectionViewProjection", reflection_vp);
    ...
    void FloorManager::BlurReflection(int passes) {
