...
//- Fragment shader logic for the sky
void fragment_sky() {
	...
	vec4 clip = vec4(vs_TexCoords * 2.0 - 1.0, 1.0, 1.0);
	...
	// 5. Adding "Sunset Wisps" using your Noise
	...
	float nebula_strength = mix(0.2, 0.6, top_mix);
