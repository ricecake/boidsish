...
// Overloads
float snoise(vec2 v) { return snoise_2d_gen(v); }
float snoise(vec3 v) { return snoise_3d_gen(v); }

// Compatibility names
float snoise2d(vec2 v) { return snoise_2d_gen(v); }
float snoise3d(vec3 v) { return snoise_3d_gen(v); }
